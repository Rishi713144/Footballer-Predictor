const footballers = [
  ...
  {
    name: "Andrés Iniesta",
    image: "https://s.yimg.com/ny/api/res/1.2/f_SI1D7ZhLzV2drrn948LA--/YXBwaWQ9aGlnaGxhbmRlcjt3PTY0MDtoPTQyNztjZj13ZWJw/https://media.zenfs.com/en/football_espana_articles_993/2f146b947dd93dc57899e2174a835bf8",
  },
  {
    name: "Xavi Hernández",
    image: "https://platform.barcablaugranes.com/wp-content/uploads/sites/21/chorus/uploads/chorus_asset/file/25819505/2191173318.jpg?quality=90&strip=all&crop=0%2C0%2C99.987501562305&w=2400",
  },
  {
  ...
  },
  {
    ...
    image: "https://i.guim.co.uk/img/media/695be08ccc972411834346ccb50f1b5d4411ba22/49_55_2451_1471/master/2451.jpg?width=1200&height=1200&quality=85&auto=format&fit=crop&s=a7e210f7b4721335a9eca1b7ee2d5660",
  },
  {
    name: "Ronaldinho",
    image: "https://media.licdn.com/dms/image/v2/D4E12AQHmcaBrpXzs0g/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1683063381087?e=2147483647&v=beta&t=uI25wJBqJOO7fcCNg2etXqte7kMJ5hAj7nKhozG35KQ",
  },
  {
    name: "Johan Cruyff",
...
const elements = {
  ...
  imageElement: document.getElementById("randomImage"),
...
function showRandomImage() {
  ...
  elements.randomButton.classList.add("clicked");
  setTimeout(() => elements.randomButton.classList.remove("clicked"), 300);
  ...
  elements.imageElement.classList.remove("show");
  elements.playerNameElement.classList.remove("show");
  elements.progressContainer.classList.add("show");
  elements.progressBar.style.width = "0%";
  elements.progressText.textContent = "Loading...";

  // Improved progress simulation: linear increment for smoother animation
  let progress = 0;
  const totalSteps = 20;
  ...
  elements.imageElement.src = currentFootballer.image;
  ...
  elements.imageElement.onload = () => {
    ...
    setTimeout(() => {
      ...
      elements.imageElement.classList.add("show");
      elements.playerNameElement.textContent = currentFootballer.name;
      elements.playerNameElement.classList.add("show");
...
function showFinalResult() {
  ...
  const userName = elements.userName.value.trim();
  alert(`${userName}, you are ${currentFootballer.name}! The program has stopped. Click Reset to start again.`);
}
...
function resetProgram() {
  ...
  elements.imageElement.classList.remove("show");
  elements.playerNameElement.textContent = "";
  elements.playerNameElement.classList.remove("show");
  elements.progressContainer.classList.remove("show");
